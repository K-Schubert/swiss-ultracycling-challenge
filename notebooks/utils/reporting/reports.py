...
def getRouteReport(df_tour, df_distance, checkpoints, mandatory_checkpoints, cp_opening_times, avg_speed, reverse=False):
    ...
    for ind in tour_slices:
        ...
        dist.append(df_distance.iloc[ind[0], ind[1]])
